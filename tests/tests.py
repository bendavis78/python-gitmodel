...
class FieldTypeCheckingTest(TestInstancesMixin, GitModelTestCase):
    ...
    def test_boolean(self):
        test_values = {True: True, False: False, 1: True, 0: False, None: False}
    ...
    def test_datetime(self):
        ...
        test_values = {
            ...
            "2001-9-11 8:46:00-0400": datetime(2001, 9, 11, 8, 46, 0, 0, utc_offset),
...
class GitObjectFieldTest(TestInstancesMixin, GitModelTestCase):
    def test_gitobject_field(self):
        ...
        obj = self.models.GitObjectTestModel(
            blob=test_blob.oid, commit=test_commit, tree=test_tree.oid
        )
        obj.save()
...
class URLFieldTest(TestInstancesMixin, GitModelTestCase):
    def test_url_field(self):
        ...
        with self.assertRaisesRegexp(self.exceptions.ValidationError, invalid_scheme):
